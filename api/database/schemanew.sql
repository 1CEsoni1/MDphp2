...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 03, 2025 at 03:45 PM
...
ALTER TABLE `tb_images`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_images_request` (`repair_request_id`),
  ADD KEY `fk_images_user` (`uploaded_by`);
...
ALTER TABLE `tb_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_notes_request` (`repair_request_id`),
  ADD KEY `fk_notes_user` (`created_by`);
...
ALTER TABLE `tb_repair_requests`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_requests_assigned_user` (`assigned_to`),
  ADD KEY `fk_requests_equipment` (`equipment_code`);
...
ALTER TABLE `tb_status_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_logs_request` (`repair_request_id`),
